...
通过在Git bash里面输入命令`hexo clean && hexo g && hexo d`即可完成网页的更新，具体流程可参考博客的[新博客工作流](https://caoyueyang.org/2025/09/01/New-Blog-Workflow/)，优化md格式可以参考本博客的[Markdown基本语法](https://caoyueyang.org/2025/09/01/Markdown-Basics/)
