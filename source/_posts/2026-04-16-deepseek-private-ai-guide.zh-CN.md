...
toc: true
---
**摘要：从官方服务繁忙的背景切入，说明为什么普通用户要考虑私有化使用 DeepSeek。**
...
## What: 什么是 AI、大模型、DeepSeek-R1 和开源……
...
<figure class="post-figure">
  <img src="/images/feishu-migration/deepseek-private-ai-guide/deepseek_local_deploy_hardware_spec.png" alt="">
  <figcaption>本地部署硬件参考</figcaption>
</figure>
