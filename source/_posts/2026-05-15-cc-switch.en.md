...
> Translation note: This English version follows the structure and figures of the corresponding Chinese post. It was reviewed and synchronized on 2026-08-03.

# Managing token access with CC-switch

CC-Switch is a cross-platform open-source tool for managing AI API access. 

Project link: [CC-Switch repository](https://github.com/farion1231/cc-switch).
